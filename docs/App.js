...
import { Button, Navbar, NavbarBrand, NavbarNav, NavbarToggler, Collapse, NavItem, Footer, NavLink, Link } from 'mdbreact';
    ...
    return (
      <Router>
        <div className="flyout">
          <Navbar color="special-color" dark expand="md" fixed="top" scrolling>
            <NavbarBrand href="/">
              <img 
            ...
            <Collapse isOpen={this.state.collapsed} navbar>
              <NavbarNav left>
                ...
                <NavItem>
                  <NavLink onClick={this.handleNavbarClick} to="/css">BLOG</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink onClick={this.handleNavbarClick} to="/aboutme">About Me</NavLink>
                </NavItem>
              </NavbarNav>
              <NavbarNav right>
                <NavItem>
                  <a href="http://www.facebook.com" class="nav-link waves-effect" target="_blank">
                    <i class="fa fa-facebook"></i>
                  </a>
                </NavItem>
                <NavItem>
                  <a href="http://www.twitter.com" class="nav-link waves-effect" target="_blank">
                    <i class="fa fa-twitter"></i>
                  </a>
                </NavItem>
                <NavItem>
                  <a href="http://www.youtube.com" class="nav-link waves-effect" target="_blank">
          ...
          <Footer color="special-color">
            <p className="footer-copyright mb-0 py-3 text-center">
              &copy; {(new Date().getFullYear())} Copyright: Alyssa Lee
            </p>
          </Footer>
        </div>
      </Router>
